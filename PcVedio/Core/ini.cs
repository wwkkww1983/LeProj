...
namespace Core
{
    ...
    public class Ini
    {
        ...
        public static string GetItemValue(string strKey)
        {
            return ReadIniData("General", strKey, "", fileName);
        }

        public static bool SetItemValue(string strKey, string strValue)
        {
            return WriteIniData("General", strKey, strValue, fileName);
        }
