...
namespace VisionManageServer
{
    ...
    public sealed class ConvertHelper
    {
        ...
        {
            return BytesToLong(data, 0, true);
        }
        ...
        /// </summary>
        /// <param name="data">需要转换成整数的byte数组</param>
        public static long BytesToLong(byte[] data, bool lowBefore)
        {
            return BytesToLong(data, 0, lowBefore);
        }
        ...
        /// <param name="data">需要转换成整数的byte数组</param>
        /// <param name="start">起始位置</param>
        public static long BytesToLong(byte[] data, int start, bool lowBefore)
        {
            int byteCount = data.Length - start;
            //如果传入的字节数组长度小于4,则返回0
            if (byteCount <= 0)
