<template>
  <div class="department-detail" v-if="depInfo">
    <div class="mycompany-title">
      ...
      <router-link :to="'/admin/MyCompany/department/'+ depInfo.id">{{depInfo.fullName}}</router-link>
    </div>
    <div class="contruct-panel">
      <div class="panel-header clearfix">
        <div class="fl" v-if="depInfo"><span class="tag-text">{{depInfo.fullName}}</span><span class="tag-text">{{depInfo.shopCode}}</span>(共{{depInfo.shopCount}}人)</div>
        <div class="pull-right">
          ...
          <el-button><router-link :to = "'/admin/MyCompany/shopAdmin/'+depInfo.id">店铺设置</router-link></el-button>
        </div>
      </div>
