<template>
    <div class="storage">
            ...
            <div class="main-box">
                <div class="sipping-header">
                    <ul class="sipping-nav">
                        <router-link tag="li" to="/work/transferStorage">调库单据<span>&nbsp>&nbsp</span></router-link>
                    ...
                    <ul class="header-btns">
                        ...
                        <li v-if="jurisdiction.single" @click="submitAudit">确认收货</li>
                                        ...
                                        <template v-if='key !== "productId"'>        
                                            ...
                                            <td v-else>
                                                <template v-if='key === "barcode"'>            
                                                    <input v-if="header.shopId" class="input-default" v-model="showData[key]" @keyup.enter="queryBarCode(showData.barcode, index)"></input>
                                                    <!-- 没选分销商时 -->
        ...
        <div class="sipping-list-right">            
            ...
            <div class="plain-money-data" v-show="this.receiptDescription.receiptStatus === '1'">
                <!-- 备注信息 -->
<!--                 <remark-template
...
import {seekProductDetail, seekReceiptDKSynopsis, seekReceiptRemark} from './../../../Api/commonality/seek'
import plainReceiptsDetail from "./../CommonalityComponent/billDetials/PlainTransferStoragel"
// impor from "./../CommonalityComponen"
export default {
    data () {
        return {
            pickerOptions0: {
    ...
    methods: {
        ...
        workProductDetails (parm, index) { // 获取商品列表
            var data = {
                ...
                "applyType": "6" // 当前应用类型：1 调库 2 退库 3 修改 4 入库 5 收货 6 发货 7 退货 8 调柜（销售除外）
            };
            ...
            seekProductDetail(data).then((response) => {
                ...
                if (response.data.state === 200) {
                    if (response.data.data.productList) {
                        ...
                        var datas = this.getconfigData(response.data.data.productList[0]);
                        this.datas.postDataList.push(datas);
                        this.datas.postDatas.push(response.data.data.productList[0]);
                    }
                } else {
        ...
        addSingleAll () { // 保存，目前不做分页保存
            ...
            let data = {
                ...
                "type": "6" // 单据类型:1 调库 2 退库 3 修改 4 入库 5 收货 6 发货 7 退货 8 调柜
            }
        ...
        getAjax () { // 权限设置
            if (sessionStorage.getItem("id") === this.receiptDescription.makeOrderManId) {  // 制单人
                if (this.receiptDescription.receiptStatus === "1") {
