  <template>
    <table border="1">
        <caption>调库明细表</caption>
        <tr>
            <td>单据号</td>
            <td colspan="2">{{StorageData.base.orderNumber}}</td>
            <td>操作部门</td>
            <td colspan="2">{{StorageData.base.dkOperation}}</td>
            <td>调出库位</td>
            <td colspan="4">{{StorageData.base.outRepository}}</td>
        </tr>
        <tr>
            <td>调入库位</td>
            <td colspan="2" >{{StorageData.base.inRepository}}</td>
            <td>商品属性</td>
            <td colspan="7">{{StorageData.base.dkProductType}}</td>
        </tr>
        <tr>
            <td>序号</td>
            <td>产品类别</td>
