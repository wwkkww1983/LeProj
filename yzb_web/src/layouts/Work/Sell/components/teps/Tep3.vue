<template>
    <div class="step">
        <p class="popTitle">
            ...
            选择珠宝名称
            <a class="skip" @click="nextView" v-show="canSkip">跳过</a>
        </p>
    ...
    methods: {
        ...
        getProduct () { // 大类个数
            ...
            seekProductClassList(options).then((response) => {
                ...
                if (JSON.parse(sessionStorage.getItem("childDa")).chooseSmall === "") {
                    this.canSkip = false;
                } else {
                    this.canSkip = true;
                }
        ...
        move (index) {
            ...
            // console.log(this.productTypeListSmall)
