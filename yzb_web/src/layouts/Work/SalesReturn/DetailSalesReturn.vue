            ...
            <div class="main-box">
                <div class="sipping-header">
                    <ul class="sipping-nav">
                        <router-link tag="li" to="/work/salesReturn">退货单据<span>&nbsp>&nbsp</span></router-link>
                        ...
                        <ul class="header-operation-btn">
                            ...
                            <li>
                                ...
                                <div class="select-w100">
                                    <el-select ref='distributorsss' filterable v-model="header.shopId" placeholder="">
                                        <el-option v-for="item in shopLists"
                                            :label="item.shopName"
                                            :value="item.shopId">
                                            <span @click="getShopName(item.shopName)">{{ item.shopName }}</span>
                                        </el-option>
                                    </el-select>
                                </div>
                            </li>
            ...
            <!--<footer class="footer-box">
                <div class="footer-affirm">
                    <ul v-if="!crudData.operationCut">
                        ...
                        <li class="confirm-btn-small" @click="batchDelect">删 除</li>
                    </ul>
                    <ul v-else>                 
...
import {seekProductDetail, seekReceiptTHSynopsis, seekReceiptRemark} from './../../../Api/commonality/seek'
import plainSalesReturn from "./../CommonalityComponent/billDetials/PlainReceiptsDetail"
export default {
    data () {
        return {
            pickerOptions0: {
    ...
    watch: {
        ...
        //     this.$refs.distributorsss.selectedLabel = this.receiptDetail.shop // 分销商
    ...
    methods: {
        ...
        workProductDetails (parm, index) { // 获取商品列表
            var data = {
                ...
                "applyType": "7" // 当前应用类型：1 调库 2 退库 3 修改 4 入库 5 收货 6 发货 7 退货 8 调柜（销售除外）
            };
        ...
        addSingleAll () { // 保存，目前不做分页保存
            ...
            let data = {
                ...
                "productTpye": this.newDatas.productTpye, // 产品类型:1 成  品2 旧料
                ...
                "type": "7" // 单据类型:1 调库 2 退库 3 修改 4 入库 5 收货 6 发货 7 退货 8 调柜
            }
