...
<div class="item-box">
   <div class="item-title">
    ...
    <div class="dialog-w380">
        <el-dialog title="新增首饰类别" v-model="popup.newPopup">
            <p class="m20">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
                    <el-form-item prop="inputSmallProductName">
                        <el-input v-model="ruleForm.inputSmallProductName" placeholder="请输入首饰类别" v-bind:maxlength="7"></el-input>
                    </el-form-item>
                </el-form>                        
            </p>
            <span slot="footer">
        ...
        <el-dialog title="新增大类首饰类别" v-model="popup.addPopup">
            <p class="m20">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
                    <el-form-item prop="inputBigProductName">
                        <el-input v-model="ruleForm.inputBigProductName" placeholder="请输入首饰类别" v-bind:maxlength="7"></el-input>
                    </el-form-item>
                </el-form>                      
            </p>
            <span slot="footer">
        ...
        <el-dialog title="修改首饰类别" v-model="popup.editNamePopup">
            <p class="m20">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
                    <el-form-item prop="inputEidtName">
                        <el-input v-model="ruleForm.inputEidtName" placeholder="请输入首饰类别" v-bind:maxlength="7"></el-input>
                    </el-form-item>
                </el-form> 
            </p>
            <span slot="footer">
