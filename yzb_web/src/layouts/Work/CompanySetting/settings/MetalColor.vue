...
<div class="item-box">
    ...
    <div class="dialog-w380">
        <el-dialog title="新增金属颜色" v-model="popup.newPopup">
            <p class="m20">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
                    <el-form-item prop="inputPartsName">
                        <el-input v-model="ruleForm.inputPartsName" placeholder="请输入 金属颜色" v-bind:maxlength="7"></el-input>
                    </el-form-item>
                </el-form>                       
            </p>
            <span slot="footer">
