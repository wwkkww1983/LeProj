  <template>
    <table border="1">
        <caption>调柜明细表</caption>
        <tr>
            <td>单据号</td>
            <td colspan="2">{{StorageData.base.orderNumber}}</td>
            <td>操作部门</td>
            <td colspan="2">{{StorageData.base.dgOperation}}</td>
            <td>调出柜组</td>
            <td colspan="4">{{StorageData.base.outCounter}}</td>
        </tr>
        <tr>
            <td>调入柜组</td>
            <td colspan="2" >{{StorageData.base.inCounter}}</td>
            <td>商品属性</td>
