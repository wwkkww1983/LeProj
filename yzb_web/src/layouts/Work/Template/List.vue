    ...
    <div>
        <div class="template-list-page">
            <div class="breadcrumb">
                <router-link class="breadcrumb-item" :to="{ name: '工作' }" exact>返回上一级</router-link>
...
import QualityTemplate from 'components/template/QualityTemplate'
import LabelTemplate from 'components/template/LabelTemplate'
import RenameTemplateDialog from 'components/template/RenameTemplateDialog'
import CopyTemplateDialog from 'components/template/CopyTemplateDialog'
import SetDefaultTemplateDialog from 'components/template/SetDefaultTemplateDialog'
import DeleteTemplateDialog from 'components/template/DeleteTemplateDialog'
import CreateTemplateDialog from 'components/template/CreateTemplateDialog'
...
export default {
    ...
    methods: {
        ...
        openSetDefaultDialog(type, templateId) {
            this.$refs.setDefaultTemplateDialog.$emit('set_data', {
                type,
                templateId
            })
        ...
        loadQualityTemplateData() {
            return this.$store.dispatch('getPrintQualityData', {
                orderId: Date.now(),
                isTmp: 1
            }).then(json => {
                if (json.state === 200) {
