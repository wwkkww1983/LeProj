    ...
    <div class="plain-detail-main" v-if="receiptsIntroList">
        ...
        <div class="body">
            <ul>
                ...
                <li v-if="receiptsIntroList.checkType" class="mt30">
                ...
                <li v-if="receiptsIntroList.shopName">
                    <span>发货库位<i class="right-icon">：</i></span>
                    <span v-if="receiptsIntroList">{{receiptsIntroList.storageName}}</span>
                </li>
                <li v-if="receiptsIntroList.storageName">
                    <span>收货店铺<i class="right-icon">：{{receiptsIntroList.shopName}}</i></span>
                    <span v-if="receiptsIntroList"></span>
                </li>
                <li>
...
// import {seekReceiptFHSynopsis} from './../../Api/commonality/seek'
...
export default {
    ...
    methods: {
        ...
        //             this.$emit('getReceiptsIntroList', response.data.data);
        //         }
        //     }, response => {
